...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject {self.fullname} with {diameter} " \
...
class CloseApproach:
    ...
    @property
    def fullname(self):
        """Return a representation of this CloseApproach."""
        return f"{self._designation}" + f"{self.neo if self.neo else ''}"
